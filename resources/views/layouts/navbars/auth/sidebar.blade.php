<!-- sidenav  -->
<aside
    class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 block w-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200  xl:left-0 ml-4 -translate-x-full xl:translate-x-0 xl:bg-transparent ">
    ...
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700" href="{{ url('dashboard') }}"
            ...
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">{{ __('Dashboard') }}</span>
        </a>
    </div>
        ...
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
              ...
              {{ Request::is('user-management') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '' }}"
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">{{ __('User Management') }}</span>
                </a>
            </li>
