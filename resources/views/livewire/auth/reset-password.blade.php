                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="p-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                                ...
                                <p class="mb-0">{{__('Here you can reset your password!')}} <br />{{__('Enter your email and your new
                                    password below!')}}</p>
                            </div>
                            ...
                            <div class="flex-auto p-6">
                                ...
                                <form wire:submit.prevent="resetPassword">
                                    ...
                                    <label for="email"
                                        class="mb-2 ml-1 font-bold text-size-xs text-slate-700">{{ __('Email') }}</label>
                                    <div class="mb-4">
                                        <input wire:model.lazy="email" type="email"
                                            ...
                                            placeholder="{{ __('Email') }}" aria-label="Email"
                                    ...
                                    <label for="password"
                                        class="mb-2 ml-1 font-bold text-size-xs text-slate-700">{{ __('Password') }}</label>
                                    <div class="mb-4">
                                        <input wire:model.lazy="password" type="password" id="password"
                                            class="
                                            focus:shadow-soft-primary-outline text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                            placeholder="{{ __('New password') }}" aria-label="Password"
                                    ...
                                    <label for="passwordConfirmation"
                                        class="mb-2 ml-1 font-bold text-size-xs text-slate-700">{{ __('Password confirmation') }}</label>
                                    <div class="mb-4">
                                        <input wire:model.lazy="passwordConfirmation" type="password"
                                            id="passwordConfirmation"
                                            class="
                                            focus:shadow-soft-primary-outline text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                            placeholder="{{ __('Confirm new password') }}" aria-label="Password"
                                            aria-describedby="password-addon" required />
