                                ...
                                <div class="flex-auto p-6">
                                    ...
                                    <form wire:submit.prevent="login">
                                        ...
                                        <div class="text-center">
                                            <button type="submit"
                                                class="inline-block w-full px-6 py-3 mt-6 mb-0 font-bold text-center text-white uppercase align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer shadow-soft-md bg-x-25 bg-150 leading-pro text-size-xs ease-soft-in tracking-tight-soft bg-gradient-cyan hover:scale-102 hover:shadow-soft-xs active:opacity-85">{{ __('Sign in') }}</button>
                                        </div>
                                    </form>
                                </div>
                                <div
                                    ...
                                    <p class="mx-auto mb-6 leading-normal text-size-sm">
                                        ...
                                        <a href="{{ route('register') }}"
                                            class="relative z-10 font-semibold text-transparent bg-gradient-cyan bg-clip-text">{{ __('Sign up') }}</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
